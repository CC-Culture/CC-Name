  ...
  return (
    <div className="min-h-screen xuan-paper-bg">
      <div className="container mx-auto px-4 py-12">
        <motion.div
          className="paper-background rounded-2xl p-12 w-full max-w-md mx-auto shadow-lg xuan-paper-bg relative overflow-hidden"
        ...
        >
          ...
          <div className="space-y-6">
            <motion.button
              ...
              className="w-full px-6 py-3 bg-[#24292e] text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-3 group relative overflow-hidden"
            ...
            <motion.button
              ...
              className="w-full px-6 py-3 bg-white text-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-3 border border-gray-300 group relative overflow-hidden"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              <svg
