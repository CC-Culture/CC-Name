  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute z-50 w-80 p-4 rounded-lg bg-gradient-to-b from-white/90 to-white/80 backdrop-blur-sm border border-[var(--dunhuang-accent)] shadow-lg text-left"
    ...
    <div className="prose max-w-none mb-8">
      ...
      >
        <Tooltip content={wuxingContent}>
          <div className="p-4 rounded-lg bg-gradient-to-b from-white/50 to-transparent border border-[var(--dunhuang-accent)] shadow-sm hover:shadow-md transition-shadow duration-300 cursor-help">
